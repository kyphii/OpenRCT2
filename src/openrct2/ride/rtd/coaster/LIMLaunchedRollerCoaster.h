...
constexpr RideTypeDescriptor LIMLaunchedRollerCoasterRTD =
{
    ...
    .RideModes = RideModes::IndexToFlags({ RideModeID::poweredLaunchPassthrough, RideModeID::poweredLaunch, RideModeID::poweredLaunchBlockSectioned }),
    .DefaultMode = RideModeID::poweredLaunch,
