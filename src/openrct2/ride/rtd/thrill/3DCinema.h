...
constexpr RideTypeDescriptor CinemaRTD =
{
    ...
    .RideModes = RideModes::IndexToFlags({ RideModeID::filmMouseTails, RideModeID::filmStormChasers, RideModeID::filmSpaceRaiders }),
    .DefaultMode = RideModeID::filmMouseTails,
