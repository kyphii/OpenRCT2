...
#pragma region Entrance page
        ...
        void onPrepareDrawEntrance()
        {
            ...
            if (gameState.scenarioOptions.objective->AllowsClosingPark())
...
#pragma region Objective page
        ...
        void onDrawObjective(RenderTarget& rt)
        {
            ...
            screenCoords.y += DrawTextWrapped(rt, screenCoords, 221, gameState.scenarioOptions.objective->format, ft);
            screenCoords.y += 5;
